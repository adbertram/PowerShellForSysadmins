describe 'Automating Operating System Install Prerequisites' {
	...
	$convertWimImageScriptPath = 'C:\Automate-The-Boring-Stuff-With-PowerShell\Part II\Automating Operating System Installs\Convert-WindowsImage.ps1'
	$vmName = 'LABDC'
	...
	it 'has the unattended XML file in the right spot' {
		'C:\Automate-The-Boring-Stuff-With-PowerShell\Part II\Automating Operating System Installs\LABDC.xml' | should exist
	}
}